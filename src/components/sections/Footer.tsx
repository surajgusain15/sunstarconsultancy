...
const footerLinks = [
  ...
  },
  {
    title: "Contact",
    links: [
      { label: "suraj@sunstarconsultancy.in", href: "mailto:suraj@sunstarconsultancy.in" },
...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/sunstarconsultancy",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/sunstarconsultancy",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/sunstarconsultancy",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <Container>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="mt-3 text-sm text-[var(--text-muted)] max-w-xs">
                Engineering reliable software that scales. Specialized in Go and PHP development.
              </p>
            </div>
              ...
              <div key={group.title}>
                ...
                <ul className="space-y-3">
                  {group.links.map((link) => (
                    <li key={link.label}>
                      <a href={link.href} className="text-sm text-[var(--text-muted)] hover:text-gold-400 transition-colors">
                        {link.label}
                      </a>
                    </li>
                  ))}
        ...
        <div className="py-6 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[var(--text-muted)]">
            © {new Date().getFullYear()} SUNSTAR CONSULTANCY. All rights reserved.
          </p>
